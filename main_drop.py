...
if __name__ == '__main__':
    ...
    parser.add_argument('-config', '-c', default='config.yaml')
    # extra data_key
    parser.add_argument('-train_set_path', default='train_high.pkl')
    parser.add_argument('-test_set_path', default='test_high.pkl')
    ...
    parser.add_argument('-load_model_num', default='0')
    parser.add_argument('-load_model_path', default='/storage/model/adaptive_vc/model')
    parser.add_argument('-auc_path', default='/storage/model/adaptive_vc/model')
