...
ksize_width=17
ksize_height=17
image_attr_path=r'D:\document\paper\personpaper\audio-visual_consistance\data\GaussianBlur\image_attr.pkl'
image_feature_path = r'D:\document\paper\personpaper\audio-visual_consistance\data\GaussianBlur\image_feature.pkl'
...
train_root=r'D:\document\paper\personpaper\audio-visual_consistance\data\GaussianBlur\train'
test_root=r'D:\document\paper\personpaper\audio-visual_consistance\data\GaussianBlur\test'
    ...
    for image_file_prefix in image_file_prefix_list:
        ...
        for line in file:
            ...
            for i in range(start_frame ,end_frame+1):
                ...
                frame_gray_blur = cv2.GaussianBlur(frame_gray, (ksize_width, ksize_height), 0)
                if figure not in test_set:
                    if image_file_prefix == real_image_file_prefix:
                        train_mean_high_image_list.append(frame_gray_blur)
                        train_mean_low_image_list.append(frame_gray_blur)
                    if image_file_prefix == high_image_file_prefix:
                        train_mean_high_image_list.append(frame_gray_blur)
                    if image_file_prefix == low_image_file_prefix:
                        train_mean_low_image_list.append(frame_gray_blur)
                image_group_list.append(frame_gray_blur)
